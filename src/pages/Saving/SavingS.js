...
const IncomeLog = () => {
  ...
  const getData = async () => {
    const res = await axios.get("http://localhost:5000/khoantietkiem");
    setData(res.data);
  };
        ...
        <section className="main">
          <section className="attendance">
            <div className="attendance-list">
              <h1>Quản lý danh sách khoản tiết kiệm</h1>
              ...
              <Modal className="incomeModel" title="Thêm mới" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
                ...
                <label>Loại khoản tiết kiệm</label>
                <input type="text" placeholder="" />
                <label>Số tiền</label>
                <input type="text" placeholder="" />
